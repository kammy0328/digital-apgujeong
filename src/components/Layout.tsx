...
export default function Layout() {
  ...
  useEffect(() => {
    ...
    const pageMeta: { [key: string]: { title: string; description: string } } = {
      '/': {
        title: '디지털 압구정 | 영상 피부 보정 전문 스튜디오',
        description: '상업 영상, 뮤직비디오, 웨딩, 퍼스널 영상의 피부 보정 전문. 티 나지 않는 완벽한 디지털 뷰티 리터칭 스튜디오.',
      },
      '/about/company': {
        title: '회사 소개 | 디지털 압구정',
        description: '디지털 압구정의 철학과 연혁, 보유 기술을 소개합니다. 전문 리터칭 소프트웨어와 숙련된 아티스트로 최고의 결과물을 제공합니다.',
      },
      '/about/director': {
        title: '병원장 인사말 | 디지털 압구정',
        description: '디지털 압구정 대표의 인사말과 서비스 철학을 확인하세요.',
      },
      '/about/staff': {
        title: '의료진 소개 | 디지털 압구정',
        description: '디지털 압구정의 전문 리터칭 아티스트를 소개합니다. 각 분야별 전문가가 최고의 결과물을 만들어 드립니다.',
      },
      '/commercial/procedures': {
        title: '상업 영상 시술 안내 | 디지털 압구정',
        description: '광고, 뮤직비디오, 드라마, 영화 등 상업 영상 피부 보정 서비스 안내. 가격표, 작업 프로세스, 납기 일정을 확인하세요.',
      },
      '/commercial/guidelines': {
        title: '시술 규정 | 디지털 압구정',
        description: '상업 영상 리터칭 서비스 규정, 데이터 전달 방법, 수정 횟수 및 파일 사양을 안내합니다.',
      },
      '/commercial/reviews': {
        title: '상업 영상 후기 | 디지털 압구정',
        description: '디지털 압구정의 상업 영상 리터칭 포트폴리오. 뮤직비디오, 광고 등 실제 작업 결과물을 확인하세요.',
      },
      '/wedding/procedures': {
        title: '웨딩 시술 안내 | 디지털 압구정',
        description: '웨딩 영상 피부 보정 패키지 안내. 기본 보정부터 프리미엄 올인원까지, 소중한 순간을 더욱 아름답게.',
      },
      '/wedding/reviews': {
        title: '웨딩 후기 | 디지털 압구정',
        description: '디지털 압구정 웨딩 영상 보정 고객 후기. 실제 신랑신부들의 생생한 리뷰를 확인하세요.',
      },
      '/event': {
        title: '이벤트 | 디지털 압구정',
        description: '디지털 압구정 특별 할인 이벤트. 한정 기간 특가 혜택을 지금 확인하세요.',
      },
      '/consultation': {
        title: '상담 안내 | 디지털 압구정',
        description: '디지털 압구정 상담 문의. 전화, 이메일, 카카오톡으로 편리하게 상담받으세요. 평일 10:00~19:00 운영.',
      },
      '/careers': {
        title: '인재 채용 | 디지털 압구정',
        description: '디지털 압구정 채용 공고. 영상 리터칭 전문가를 모집합니다. 지원 자격 및 방법을 확인하세요.',
      },
    };
