...
export default function YouTubeCard({ videoId, title, onClick }: { key?: React.Key, videoId: string, title: string, onClick: () => void }) {
  ...
  return (
    <div
      className="relative aspect-video bg-neutral-950 border border-neutral-800 overflow-hidden group cursor-pointer"
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-100 group-hover:opacity-0 transition-opacity duration-300">
