      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed inset-0 z-40 bg-black pt-24 px-6 md:hidden flex flex-col space-y-6 text-xl font-serif text-white overflow-y-auto pb-12"
          >
        ...
        <AnimatePresence>
          {showTooltip && (
            <motion.div
              ...
              className="bg-neutral-900 text-white px-4 py-2 rounded-xl shadow-lg shadow-black/50 text-xs font-medium border border-neutral-700 relative mb-2 cursor-pointer"
      ...
      <footer className="bg-neutral-950 border-t border-neutral-900 text-neutral-400 py-16 text-sm">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="md:text-right font-light">
            ...
            <Link to="/careers" className="inline-block mt-2 text-neutral-400 hover:text-white transition-colors border-b border-neutral-700 hover:border-white pb-0.5">
              인재 채용
            </Link>
          </div>
        </div>
